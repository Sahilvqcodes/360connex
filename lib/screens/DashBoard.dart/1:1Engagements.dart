...
class MeetingEngagements extends GetView<StoreController> {
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: TabBarView(
                        children: <Widget>[
                          ...List.generate(2, ((i) {
                            return controller.BrandsName.length != 0
                                ? FutureBuilder(
                                    future:
                                        DashBoardApi.getMeetingsAndActivites(
                                            context,
                                    ...
                                    builder: (BuildContext context,
                                      ...
                                      List<MeetingsActivitiesData>?
                                          _meetingsActivitesList =
                                          snapshot.data;
                                      MeetingsActivitiesData?
                                          _meetingsActivites =
                                          _meetingsActivitesList?[0];
                                      List<MeetingsActivitesRecords>?
                                          _upcomingList;
                                                              ...
                                                              children: [
                                                                Container(
                                                                  ...
                                                                  decoration:
                                                                    ...
                                                                    shape: BoxShape
                                                                        .circle,
                                                                    color: "${_upcomingList?[index].masterEngagementR!.brandMasterR!.colorC}"
                                                                        .toColor(),
                                                                  ),
                                                                ),
                                                                const SizedBox(
