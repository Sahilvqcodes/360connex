...
class _TotalEngagementsState extends State<TotalEngagements> {
  RxList _selectedItems = [].obs;

  @override
  void initState() {
    _selectedItems = widget.brandFocus;
    print("widget.brandFocus ${widget.brandFocus} ");
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    print("_selectedItems brandFocus $_selectedItems");
    return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            FutureBuilder(
                // future:
                // DashBoardApi.getTotalEngagements(context, _selectedItems),
